...
void item_market_t::read_from_file(std::istream& file)
{
...
void item_market_t::read_from_buffer(std::string_view buffer)
{
...
void item_market_t::read_from_json(const Json::Value& json_root)
{
...
void item_market_t::write_to_file(std::ostream& file, unsigned indent_start, unsigned spaces_per_tab) const
{
...
void item_market_t::write_to_buffer(std::string& buffer, unsigned indent_start, unsigned spaces_per_tab) const
{
