...
class item_attributes_t
{
    ...
    public:
        ...
        inline item_attributes_t(const item_attributes_t& source) = default;
        
        /// @brief Move constructor
        inline item_attributes_t(item_attributes_t&& source) = default;
        
        // Add member initialization constructors here
        // Try to use initializer lists when possible.
        
        /// @brief See @ref fetch.
        inline item_attributes_t(const item_ids_t& item_ids)
        {
            this->fetch(item_ids);
        }
        ...
        inline item_attributes_t(std::istream& file)
        {
            this->decode(file);
        }
        ...
        /// @exception error_message_t
        /// @exception Json::Exception
        inline item_attributes_t(std::string_view buffer)
        {
            this->decode(buffer);
        }
        ...
        ///
        /// @exception error_message_t
        inline item_attributes_t(const Json::Value& json_root)
        {
        ...
        inline item_attributes_t& operator=(const item_attributes_t& source) = default;
        
        /// @brief Assignment operator with shallow copy.
        inline item_attributes_t& operator=(item_attributes_t&& source) = default;
        
        /// @brief See @ref decode(std::istream& file)
        ///
        /// @exception error_message_t
        /// @exception Json::Exception
        inline item_attributes_t& operator=(std::istream& file)
        {
            this->decode(file);
            return *this;
        }
        ...
        /// @exception error_message_t
        /// @exception Json::Exception
        inline item_attributes_t& operator=(std::string_view buffer)
        {
            this->decode(buffer);
            return *this;
        }
        ...
        ///
        /// @exception error_message_t
        inline item_attributes_t& operator=(const Json::Value& json_root)
        {
            this->decode(json_root);
            return *this;
        }
