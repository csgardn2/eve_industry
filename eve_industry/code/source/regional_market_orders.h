/// @file regional_market_orders.h
/// @brief Declaration of @ref regional_market_orders_t class
/// 
/// * Contact conor.gardner@arm.com if you have questions about this code.
/// * Date Created = Friday November 3 2017
/// * Documentation is generated by doxygen, see html/index.html

#ifndef HEADER_GUARD_REGIONAL_MARKET_ORDERS
#define HEADER_GUARD_REGIONAL_MARKET_ORDERS
...
class regional_market_orders_t : public std::vector<order_t>
{
    ...
    public:
        ...
        inline regional_market_orders_t() = default;
...
inline std::ostream& operator<<(std::ostream& stream, regional_market_orders_t::error_code_t error_code)
{
    stream << regional_market_orders_t::error_message_t::enum_to_string(error_code);
    return stream;
}

/// @brief Convenience alias to allow printing directly via cout or similar.
inline std::ostream& operator<<(std::ostream& stream, const regional_market_orders_t::error_message_t& error_message)
{
...
/// @brief Convenience alias to allow printing directly via cout or similar.
inline std::ostream& operator<<(std::ostream& stream, const regional_market_orders_t& source)
{
...
/// @brief Convenience alias to allow printing directly via cout or similar.
inline std::string& operator<<(std::string& buffer, const regional_market_orders_t& source)
{
...
/// @brief Extraction operator for decoding.
inline std::string_view operator>>(std::string_view& buffer, regional_market_orders_t& destination)
{
...
/// @brief Extraction operator for decoding.
inline Json::Value operator>>(const Json::Value& json_root, regional_market_orders_t& destination)
{
