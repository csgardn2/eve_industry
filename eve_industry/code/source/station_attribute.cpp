...
void station_attribute_t::read_from_file(std::istream& file)
{
...
void station_attribute_t::read_from_buffer(std::string_view buffer)
{
...
void station_attribute_t::read_from_json(const Json::Value& json_root)
{
...
void station_attribute_t::write_to_file(std::ostream& file, unsigned indent_start, unsigned spaces_per_tab) const
{
...
void station_attribute_t::write_to_buffer(std::string& buffer, unsigned indent_start, unsigned spaces_per_tab) const
{
